...
class UserStatistics(db.Model):
    ...
    total_courses_enrolled = db.Column(db.Integer, default=0, nullable=False)
    courses_completed = db.Column(db.Integer, default=0, nullable=False)

    # Performance Statistics
    average_quiz_score = db.Column(db.Numeric(5, 2), nullable=True)

    # Achievement Statistics
    total_certificates = db.Column(db.Integer, default=0, nullable=False)

    # Learning Statistics
    total_study_hours = db.Column(db.Numeric(8, 2), default=0, nullable=False)
    learning_streak_days = db.Column(db.Integer, default=0, nullable=False)
    ...
    def to_dict(self):
        ...
        return {
            ...
            "average_quiz_score": (
                float(self.average_quiz_score) if self.average_quiz_score else None
            ),
