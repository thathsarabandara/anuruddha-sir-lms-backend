...
class UserPreferences(db.Model):
    ...
    notifications_email = db.Column(db.Boolean, default=True, nullable=False)
    notifications_sms = db.Column(db.Boolean, default=False, nullable=False)
    notifications_in_app = db.Column(db.Boolean, default=True, nullable=False)

    # Advanced Settings (JSON)
    notification_settings = db.Column(db.Text, nullable=True)
    privacy_settings = db.Column(db.Text, nullable=True)
