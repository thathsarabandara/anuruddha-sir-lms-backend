...
class OTPRequest(db.Model):
    ...
    # Foreign Key
    user_id = db.Column(
        db.String(36), db.ForeignKey("users.user_id", ondelete="CASCADE"), nullable=True, index=True
    )
    ...
    # Token & OTP
    verification_token = db.Column(db.String(255), unique=True, nullable=False, index=True)
