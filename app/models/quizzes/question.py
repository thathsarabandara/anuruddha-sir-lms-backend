...
class Question(db.Model):
    ...
    Attributes:
        ...
        question_type: ENUM(multiple_choice, multiple_answer, short_answer,
    ...
    difficulty = db.Column(db.Enum("easy", "medium", "hard"), default="medium", nullable=False)
    ...
    options = db.relationship(
        "QuestionOption", backref="question", lazy="dynamic", cascade="all, delete-orphan"
    )
    attempt_answers = db.relationship(
        "AttemptAnswer", backref="question", lazy="dynamic", cascade="all, delete-orphan"
    )
