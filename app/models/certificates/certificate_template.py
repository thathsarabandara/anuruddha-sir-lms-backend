...
class CertificateTemplate(db.Model):
    ...
    template_image_url = db.Column(db.Text, nullable=True)

    signature_image_url = db.Column(db.Text, nullable=True)

    logo_image_url = db.Column(db.Text, nullable=True)

    signature_name = db.Column(db.String(255), nullable=True)

    signature_title = db.Column(db.String(255), nullable=True)
