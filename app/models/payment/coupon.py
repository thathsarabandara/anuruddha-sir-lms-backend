...
class Coupon(db.Model):
    ...
    coupon_code = db.Column(db.String(50), nullable=False, unique=True, index=True)

    discount_type = db.Column(db.Enum("percentage", "fixed"), default="percentage", nullable=False)

    discount_value = db.Column(db.Numeric(10, 2), nullable=False)

    applicable_courses = db.Column(db.JSON, nullable=True)
    ...
    # Relationships
    transactions = db.relationship("Transaction", backref="coupon", lazy=True)
