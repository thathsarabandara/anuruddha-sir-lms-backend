...
class Review(db.Model):
    ...
    # Status & Moderation
    status = db.Column(
        db.Enum("pending", "approved", "rejected", "deleted"),
        default="pending",
        nullable=False,
        index=True,
    )
    ...
    responses = db.relationship(
        "ReviewResponse", backref="review", lazy="dynamic", cascade="all, delete-orphan"
    )
    votes = db.relationship(
        "ReviewVote", backref="review", lazy="dynamic", cascade="all, delete-orphan"
    )
    flags = db.relationship(
        "ReviewFlag", backref="review", lazy="dynamic", cascade="all, delete-orphan"
    )
